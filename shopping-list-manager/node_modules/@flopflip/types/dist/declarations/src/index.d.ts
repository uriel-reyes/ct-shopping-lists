import { type LDClient as TLDClient, type LDContext, type LDOptions as TLDOptions } from 'launchdarkly-js-client-sdk';
import type React from 'react';
export type TFlagName = string;
export type TFlagVariation = boolean | string | number | Record<string, unknown> | unknown[];
...
export declare enum AdapterConfigurationStatus {
    Unconfigured = 0,
    Configuring = 1,
    Configured = 2
}
export declare enum AdapterInitializationStatus {
    Succeeded = 0,
    Failed = 1
}
...
export type TBaseAdapterArgs<TAdditionalUserProperties = TDefaultAdditionalUserProperties> = {
    user: TUser<TAdditionalUserProperties>;
};
export type TLaunchDarklyContextArgs = {
    context: LDContext;
};
...
export type TGraphQlAdapterArgs<TAdditionalUserProperties = TDefaultAdditionalUserProperties> = TBaseAdapterArgs<TAdditionalUserProperties> & {
...
export type THttpAdapterArgs<TAdditionalUserProperties = TDefaultAdditionalUserProperties> = TBaseAdapterArgs<TAdditionalUserProperties> & {
    execute: () => Promise<any>;
    pollingIntervalMs?: number;
    cacheIdentifier?: TCacheIdentifiers;
};
export type TLocalStorageAdapterArgs<TAdditionalUserProperties = TDefaultAdditionalUserProperties> = TBaseAdapterArgs<TAdditionalUserProperties> & {
    pollingIntervalMs?: number;
};
export type TMemoryAdapterArgs<TAdditionalUserProperties = TDefaultAdditionalUserProperties> = TBaseAdapterArgs<TAdditionalUserProperties>;
...
export type TAdapterArgs = TLaunchDarklyAdapterArgs | TLocalStorageAdapterArgs | TMemoryAdapterArgs | TSplitioAdapterArgs | TGraphQlAdapterArgs | THttpAdapterArgs | TCombinedAdapterArgs;
export declare const adapterIdentifiers: {
...
export type TAdapterIdentifiers = (typeof adapterIdentifiers)[keyof typeof adapterIdentifiers] | string;
export type TFlagsContext = Record<TAdapterIdentifiers, TFlags>;
export declare const cacheIdentifiers: {
...
export type TFlagsUpdateFunction = (flags: TFlags, options?: TUpdateFlagsOptions) => void;
...
export type TAdapter = TLaunchDarklyAdapterInterface | TLocalStorageAdapterInterface | TMemoryAdapterInterface | TSplitioAdapterInterface | TGraphQlAdapterInterface | THttpAdapterInterface | TCombinedAdapterInterface;
...
export type TConfigureAdapterChildrenAsFunction = (args: TConfigureAdapterChildrenAsFunctionArgs) => React.ReactNode;
export type TConfigureAdapterChildren = TConfigureAdapterChildrenAsFunction | React.ReactNode;
export type TReconfigureAdapter = (adapterArgs: TAdapterArgs, options: TAdapterReconfigurationOptions) => void;
...
export type TDiff<ExcludedFrom, ToExclude> = Pick<ExcludedFrom, Exclude<keyof ExcludedFrom, keyof ToExclude>>;
export type TCache = {
