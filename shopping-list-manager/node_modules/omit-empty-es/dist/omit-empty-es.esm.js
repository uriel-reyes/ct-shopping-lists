...
function kindOf(val) {
  ...
  return _sliceInstanceProperty(type).call(type, 8, -1).toLowerCase().replace(/\s/g, '');
} // @ts-expect-error
...
function isArray(val) {
  if (_Array$isArray) return _Array$isArray(val);
...
function isRegexp(val) {
  ...
  return typeof _flagsInstanceProperty(val) === 'string' && typeof val.ignoreCase === 'boolean' && typeof val.multiline === 'boolean' && typeof val.global === 'boolean';
} // @ts-expect-error
...
function isArguments(val) {
  try {
    ...
    if (_indexOfInstanceProperty(_context = err.message).call(_context, 'callee') !== -1) {
      return true;
    }
  }
...
var omitEmpty = function omitEmpty(obj, options) {
  ...
  var omit = function omit(value) {
    if (_Array$isArray(value)) {
      ...
      // @ts-expect-error
      value = _filterInstanceProperty(_context = _mapInstanceProperty(value).call(value, function (v) {
        return omit(v);
...
function isEmpty(value, omitZero) {
  switch (kindOf(value)) {
    ...
    case 'object':
      // eslint-disable-next-line no-restricted-syntax
      for (var _i2 = 0, _Object$keys3 = _Object$keys2(value); _i2 < _Object$keys3.length; _i2++) {
