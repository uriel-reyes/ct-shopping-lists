...
var servicePageProjectSwitcher = require('./service-page-project-switcher-698c4abe.cjs.prod.js');
var jsxRuntime = require('@emotion/react/jsx-runtime');
require('@emotion/styled/base');
require('react-router-dom');
require('@commercetools-frontend/application-shell-connectors');
require('./index-ae549827.cjs.prod.js');
require('prop-types');
require('react');
...
const ProjectNotInitialized = () => {
  ...
  return jsxRuntime.jsx(applicationComponents.MaintenancePageLayout, {
    imageSrc: ProjectExpiredIllustration__default["default"],
