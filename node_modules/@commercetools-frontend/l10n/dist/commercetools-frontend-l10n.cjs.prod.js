...
const getImportChunk$2 = locale => {
  ...
  switch (intlLocale) {
    case 'de':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "currency-data-de" */'./de-cfa94be6.cjs.prod.js'); });
    case 'es':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "currency-data-es" */'./es-c77f831e.cjs.prod.js'); });
    case 'fr-FR':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "currency-data-fr-FR" */'./fr-FR-81736e01.cjs.prod.js'); });
    case 'pt-BR':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "currency-data-pt-BR" */'./pt-BR-dc4eb16c.cjs.prod.js'); });
    case 'zh-CN':
...
const getImportChunk$1 = locale => {
  ...
  switch (intlLocale) {
    case 'de':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "language-data-de" */'./de-5a1f8746.cjs.prod.js'); });
    case 'es':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "language-data-es" */'./es-81fab9ff.cjs.prod.js'); });
    case 'fr-FR':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "language-data-fr-FR" */'./fr-FR-f42c6d4f.cjs.prod.js'); });
    case 'pt-BR':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "language-data-pt-BR" */'./pt-BR-3e3be9eb.cjs.prod.js'); });
    case 'zh-CN':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "language-data-zh-CN" */'./zh-CN-d37844cc.cjs.prod.js'); });
    default:
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "language-data-en" */'./en-b12f7e90.cjs.prod.js'); });
  }
};
