...
function createMcDevAuthenticationMiddleware(applicationConfig) {
  ...
  return (request, response, next) => {
    ...
    if ((_applicationConfig$en = applicationConfig.env.__DEVELOPMENT__) !== null && _applicationConfig$en !== void 0 && (_applicationConfig$en = _applicationConfig$en.oidc) !== null && _applicationConfig$en !== void 0 && _applicationConfig$en.authorizeUrl) {
      ...
      if ((_applicationConfig$en2 = applicationConfig.env.__DEVELOPMENT__) !== null && _applicationConfig$en2 !== void 0 && (_applicationConfig$en2 = _applicationConfig$en2.oidc) !== null && _applicationConfig$en2 !== void 0 && _startsWithInstanceProperty__default["default"](_context = _applicationConfig$en2.authorizeUrl).call(_context, 'http://localhost')) {
